<script lang="ts">
  ...
  import { TIERS, humanAge, formatBytes, formatDuration, tierNotDueYet, backupAgeLabel } from '$lib/stats/backups';
  import type { BackupTier, TierData, DriveHealth } from '$lib/stats/backups';
